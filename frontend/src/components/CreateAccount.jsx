    ...
    return(
        <div className="bg-white rounded-xl flex px-6 sm:px-10 md:px-14 lg:px-12 my-10 md:mx-10 items-center gap-5">
            ...
            <div className="flex-1 py-8 sm:py-10 md:py-14 lg:py-18">
                ...
                <p className="mt-4 text-primary text-lg md:text-xl lg:text-2xl">Now your next appointment is just a click away with <strong className="underline">medix</strong>.</p>
            </div>
        </div>
    );
}
